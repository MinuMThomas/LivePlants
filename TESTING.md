...
| Item in stock | Item in stock, add to bag and qty button displays,  | clicked | PASS | PASS |
...
| Testing | Expected Outcome | Steps | Hover | Results |
|--------|---------|---------|---------|---------|
| header displays the correct label | displayed | n/a | n/a | PASS | 
| cards display correct info | displayed | n/a | n/a | PASS | 
| image field | Clicking on image field brings you to Blog detail page | clicked | n/a | PASS | 
| Back to top | Clicking brings you to the top of the page | Clicked | PASS | PASS |
...
| Testing | Expected Outcome | Steps | Hover | Results |
|--------|---------|---------|---------|---------|
| Displays Blog info | displayed | clicked on blog image | n/a | PASS | 
...
| ITEMS TOAST MESSAGES |
| Update Info | Update info message appears | Updated info | n/a | PASS |
...
|--------|---------|---------|---------|---------|
| Full order summary is displayed | display | n/a | n/a | PASS |
| Back to Home button | go back to home page | click button | PASS | PASS | 
...
| Continue shopping | clicking brings to all items page | clicked button | PASS | PASS |
|Cart with items |
| Items displayed | Display items | n/a | n/a | PASS | 
| Quantity button | add and minus buttons work | pressed plus and minus buttons | PASS | PASS |
| Quantity button disabled | minus button disables when item is at 1 , plus disable when items are at 98 | pressed plus and minus buttons | PASS | PASS |
...
| Subtotal calculated | correct value | n/a | n/a | PASS | 
| Continue shopping | clicking brings to all items page | clicked button | PASS | PASS |
| DELIVERY CHARGES |
| Delivery threshold met | Delivery charge is 0, free delivery message in blue | Added amount over 60euro | n/a | PASS | 
| Delivery threshold unmet | Delivery charge is added, Free delivery prompt message in red | Added amount under 60euro | n/a | PASS | 
| Continue shopping | clicking brings to all items page | clicked button | PASS | PASS |
| Back to top | Clicking brings you to the top of the page | Clicked | PASS | PASS |
...
| Quantity input negative numbers | cannot add negative numbers | Added negative number in  | PASS ||
| Delete an Item in cart - item page | Your Comment was deleted message appears | Deleted an item | PASS ||
| Delete an Item in cart - cart page| Your Item was deleted message appears | Deleted an item | PASS ||
...
| Relevant field and labels are displayed | Displayed | n/a | n/a |  PASS |
| Form Validation EMPTY | Form validation will prompt for user action if empty form is submitted |   Try to submit empty form | n/a | PASS |
| Form Validation Only Required Fields | Form validation will prompt for user action to fill content if only title is filled |  Try to submit only title | n/a | PASS |
...
| Confirmation EMAIL | complete purchase and submit Order Confirmation email with details of order | Fill all details of form and submit | n/a |  PASS |
| Order goes to order history | Order goes to order history | Completed order went to profile | n/a |  PASS |
| Stripe payment | Stripe payment working | Completed order went to Stripe Developer Webhooks | n/a |  PASS |
| ITEMS TOAST MESSAGES |
| Success message | Confirmation message appears with order number | Completed a purchase | n/a | PASS |
...
| Testing | Expected Outcome | Steps | Results | Hover |
|--------|---------|---------|---------|---------|
| Review form submissions are rendered for correct item | Rendered to the item | n/a | n/a |  PASS | 
| header displays the correct label | Reviews header should match the item | clicked on reviews | PASS | PASS | 
| appear by Oldest to newest | displayed | n/a | n/a |  PASS |
| All fields are displayed | displayed | added a review | n/a | PASS | 
| Continue shopping | clicking brings to all items page | clicked button | PASS | PASS |
...
| Testing | Expected Outcome | Steps | Results | |
|--------|---------|---------|---------|--------|
| Relevant field and labels are displayed | displayed | n/a |PASS |  |
...
#### ADD ITEM FORM - Admin Feature
| Testing | Expected Outcome | Steps | Hover | Results |
|--------|---------|---------|---------|---------
| ACCESS | Can only be accessed by Admin | n/a|n/a | PASS |
| Relevant field and labels are displayed | Displayed | n/a | n/a | PASS |
| Category Dropdown | clicking displays a list of options | clicked | PASS | PASS |
| Form Validation EMPTY | Form validation will prompt for user action if empty form is submitted |   Try to submit empty form | n/a |PASS |
| Form Validation Only Required Fields | Dsiplays item in store and in the correct category fields |  Submitted from filled correctly  | n/a| PASS |
| Form Validation ALL DETAILS | Fill all details of form | User returned to homepage and post is displayed with all relevant info on all items page and all extra details on the items detail page, post appears in relevant category search |n/a | PASS |
...
| All fields are displayed | n/a |n/a | n/a | PASS |
...
|--------|---------|---------|---------|---------
| ACCESS | Can only be accessed by Admin |n/a | n/a| PASS |
| Image renders | Image of item renders | n/a | n/a | PASS |
...
| Blog | Bloglink brings you to the blog page | Clicked blog link | PASS | PASS |
